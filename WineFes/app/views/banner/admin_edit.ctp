<input data="<?php echo $id?>" title="替换图片 960px×395px" type="file" id="banner_<?php echo $id?>" name="banner_<?php echo $id?>" /> 
...
<img src="<?php echo $this->Format->getBanner($banner['Banner'])?>" style="display:none" />