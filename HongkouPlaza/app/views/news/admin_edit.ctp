<div id="containerHolder">
	<div id="container">
        <div id="main" class="main">
			<?php echo $this->Form->create('News', array('class'=>'jNice', 'type'=>'file', 'url'=>array('action'=>'update', 'admin'=>true)))?>
				...
				<div class="news_right">
					...
					<fieldset>
						...
						<p>
							...
							<?php if($this->data['News']['image']):?>
							<?php echo $this->Html->image('/attachments/photos/news_image/'.$this->data['News']['image'])?>
							<span>删除这张图片</span> <?php echo $this->Form->checkbox('image_delete')?>
							<?php endif;?>
