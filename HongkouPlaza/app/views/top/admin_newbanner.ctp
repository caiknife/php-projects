<div id="containerHolder">
    <div id="container">
        ...
        <!-- // #sidebar -->
        <div id="main">
            <?php echo $this->Form->create(null, array('type'=>'file', 'class'=>'jNice', 'url'=>array('action'=>'createbanner', 'admin'=>true)))?>
                ...
                <div class="posters_right">
                    ...
                    <fieldset>
                        ...
                        <p><label>文字描述</label><?php echo $this->Form->textarea('HomeBanner.description', array('rows'=>1, 'cols'=>1))?></p>
                    </fieldset>
                </div>
                <br clear="all" />
