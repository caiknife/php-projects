<div id="containerHolder">
	<div id="container">
        <div id="main" class="main">
			<?php echo $this->Form->create('Brand', array('type'=>'file', 'url'=>array('action'=>'create', 'admin'=>true), 'class'=>'jNice'))?>
						...
						<div class="brand_right">
							...
							<div class="typeList">
								...
								<ul class="checkboxList">
									...
									<li><label><strong <?php if($key<=11):?>class="red"<?php endif;?>><?php echo h($val);?></strong> <input type="checkbox" data="<?php echo $key?>" name="categories[<?php echo $key?>]" <?php if(isset($this->params['form']['categories'][$key])):?>checked<?php endif;?> /></label></li>
									<?php endforeach;?>
								</ul>
