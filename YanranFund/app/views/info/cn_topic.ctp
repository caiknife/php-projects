<div id="main">
    ...
    <ul class="newsList_02">
        ...
        <li>
            <a target="_blank" class="downloadType <?php echo $this->Format->getFileType($topic['Topic']['banner_file_path'])?>" href="<?php echo $this->Html->url(array('controller'=>'resource', 'action'=>'download', $topic['Topic']['banner_file_path']))?>">立即下载<br /><?php echo $topic['Topic']['banner_file_size']?></a>
