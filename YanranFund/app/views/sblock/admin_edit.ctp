<div id="content">
    <?php echo $this->Form->create('Sblock', array('type'=>'file', 'url'=>array('controller'=>'sblock', 'action'=>'update', 'admin'=>true)))?>
        ...
        <div class="tabRight">
            <div class="release">
                <p>
                    ...
                    <a class="del" href="<?php echo $this->Html->url(array('action'=>'delete', $sblock['Sblock']['id']))?>">删除</a><!-- 固定板块不可删除-->
                    <?php endif;?>
                </p>
            </div>
        </div>
...
<?php echo $this->Html->script('admin/sblock/edit')?>