        ...
        <div class="tabRight">
            <div class="release">
                <p>
                    ...
                    <a class="update" href="#">保存</a>
                     -->
                    <a class="del" href="<?php echo $this->Html->url(array('action'=>'delete', $news['News']['id']))?>">删除</a>
                </p>  
            </div>
            <div class="tabRightBox">
                ...
                <fieldset>
                    ...
                    <?php if($news['News']['banner_file_path']):?>
                    <img id="news_image" src="<?php echo $this->Format->getNewsListImage($news['News'])?>" />
                    <?php endif;?>
                </fieldset>
            </div>
            <div class="tabRightBox">
        ...
        <div class="tabLeft">
            ...
            <fieldset class="searchBar">
                ...
                <div id="projectDiv">
                    ...
                    <a title="移除" href="<?php echo $this->Html->url(array('action'=>'disconnect', $news['News']['id'], $project['id']))?>" class="disconnect"><?php echo h($project['title_cn'])?> | <?php echo h($project['title_en'])?></a>
                    <?php endforeach;?> 
                </div>
            </fieldset>
            <fieldset>
...
<?php echo $this->Html->script('admin/news/edit')?>